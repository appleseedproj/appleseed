...
<body id="www-website-com">
    ...
    <footer id="appleseed-footer" class="container_16">
    	...
    	<p> <a href='http://opensource.appleseedproject.org'>Appleseed Social Networking Software</a> is Copyright &copy; 2004-2010 by the Appleseed Project under the GNU General Public License. All Rights Reserved. </p>
