create table `#__AccessControl` ( `tID` int(10) unsigned NOT NULL AUTO_INCREMENT, `Account` varchar(255) NOT NULL, `Location` varchar(128) NOT NULL DEFAULT '', `r` tinyint(1) DEFAULT '0', `w` tinyint(1) DEFAULT '0', `a` tinyint(1) DEFAULT '0', `Inheritance` tinyint(1) DEFAULT '0', PRIMARY KEY (`tID`) ) ENGINE=MyISAM DEFAULT CHARSET=latin1;
