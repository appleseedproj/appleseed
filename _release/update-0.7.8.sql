...
create table `#__PageReferences` ( `Reference_PK` int(11) NOT NULL AUTO_INCREMENT, `User_FK` int(11) NOT NULL, `Identifier` char(32) DEFAULT NULL, `Type` char(16) DEFAULT NULL, `Stamp` datetime DEFAULT NULL, PRIMARY KEY (`Reference_PK`) ) ENGINE=MyISAM DEFAULT CHARSET=latin1;
...
create table `#__NotificationsUpdated` ( `Updated_PK` int(11) NOT NULL AUTO_INCREMENT, `Owner_FK` int(11) DEFAULT NULL, `Friend` char(128) DEFAULT NULL, `Updated` datetime DEFAULT NULL, PRIMARY KEY (`Updated_PK`) ) ENGINE=MyISAM DEFAULT CHARSET=utf8;
