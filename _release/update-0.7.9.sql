...
create table `#__SearchResults` ( `Result_PK` int(11) NOT NULL AUTO_INCREMENT, `User_FK` int(11) DEFAULT NULL, `Source` char(128), `Keywords` text, `Title` char(255) DEFAULT NULL, `Link` char(255) DEFAULT NULL, `Icon` char(255), `Owner` char(128) DEFAULT NULL, `Description` text, `Stamp` datetime DEFAULT NULL, `Created` datetime DEFAULT NULL, PRIMARY KEY (`Result_PK`) ) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
create table `#__FriendPing` ( `Ping_PK` int(11) NOT NULL AUTO_INCREMENT, `Sender` char(128) DEFAULT NULL, `Recipient` char(128) DEFAULT NULL, `Created` datetime DEFAULT NULL, `Status` tinyint(1) DEFAULT '0', PRIMARY KEY (`Ping_PK`) ) ENGINE=MyISAM DEFAULT CHARSET=utf8;
