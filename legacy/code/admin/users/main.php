<?php
  ...
  $zOLDAPPLE->Initialize("admin.users", TRUE);
  ...
  global $gSelectedTab;
  $gSelectedTab['admin_users_main'] = 'selected';


  // Check if user has admin access to this page.
  if ($zLOCALUSER->userAccess->a == TRUE) {
    $mainlocation = "$gFRAMELOCATION/objects/admin/users/main.aobj";
  } else {
    $mainlocation = "$gFRAMELOCATION/objects/admin/common/denied.aobj";
  } // if

  // Include the outline frame.
  $zOLDAPPLE->IncludeFile ("$gFRAMELOCATION/frames/admin/users/main.afrw", INCLUDE_SECURITY_NONE);
