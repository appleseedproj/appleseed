<?php
  ...
  $zOLDAPPLE->Initialize('admin.users.access', TRUE);
  ...
  if ($zLOCALUSER->userAccess->a == TRUE) {
    ...
    switch ($gACTION) {
      case 'EDIT':
        $zOLDAPPLE->IncludeFile ("$gFRAMELOCATION/objects/admin/users/access/edit.aobj", INCLUDE_SECURITY_NONE);
      break;
      case 'NEW':
        $zOLDAPPLE->IncludeFile ("$gFRAMELOCATION/objects/admin/users/access/new.aobj", INCLUDE_SECURITY_NONE);
      break;
      case 'SAVE':
        // Skip to the default.
      default:
        if ( ($ADMINDATA->Error == 0) OR 
          ...
          $zOLDAPPLE->IncludeFile ("$gFRAMELOCATION/objects/admin/users/access/list.top.aobj", INCLUDE_SECURITY_NONE);

          // Calculate scroll values.
          $gSCROLLMAX[$zOLDAPPLE->Context] = $ADMINDATA->CountResult();

          // Adjust for a recently deleted entry.
          $zOLDAPPLE->AdjustScroll ('admin.users.access', $ADMINDATA);
          ...
          $zOLDAPPLE->IncludeFile ("$gFRAMELOCATION/objects/admin/users/access/list.bottom.aobj", INCLUDE_SECURITY_NONE);
  ...
  $zOLDAPPLE->IncludeFile ("$gFRAMELOCATION/frames/admin/users/access.afrw", INCLUDE_SECURITY_NONE);
