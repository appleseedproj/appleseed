<?php
  ...
  // | LOCATION: /code/admin/control/               MODIFIED: 04-11-2007 +
  // +-------------------------------------------------------------------+
  ...
  // +-------------------------------------------------------------------+
  // | VERSION:      0.7.3                                               |
  // | DESCRIPTION:  Control administration page.                        |
  // +-------------------------------------------------------------------+
  ...
  $zOLDAPPLE->Initialize("admin.control", TRUE);
  ...
  if ($zLOCALUSER->userAccess->a == TRUE) {
    $mainlocation = "$gFRAMELOCATION/objects/admin/control/main.aobj";
  } else {
    $mainlocation = "$gFRAMELOCATION/objects/admin/common/denied.aobj";
  } // if

  // Include the outline frame.
  $zOLDAPPLE->IncludeFile ("$gFRAMELOCATION/frames/admin/control/main.afrw", INCLUDE_SECURITY_NONE);
