<?php
  ...
  class cOLDAPPLESEED extends cOLDAPPLICATION {
    ...
    function Initialize ($pCONTEXT = "", $pREGISTERGLOBALS = FALSE) {
      ...
      if (file_exists ('legacy/code/include/data/cache/fields.acache')) include_once ('legacy/code/include/data/cache/fields.acache');
      if (file_exists ('legacy/code/include/data/cache/columns.acache')) include_once ('legacy/code/include/data/cache/columns.acache');
