...
<section id="profile-friends">
	...
	<span class="profile-friends-circle-add-friend">
		<form class="friend-in-circle-edit" method="post">
			<input type="hidden" name="Task" value="ApplyToCircle">
			<input type="hidden" name="Context">
			<input type="hidden" name="Circle">
			<select class='friend-in-circle-list' name="Friend">
			</select>
			<button class="friends-in-circle-edit-save" name="Task" value="ApplyToCircle">Save</button>
		</form>
	</span>
