<?php
  ...
  $zAPPLE->Initialize("admin.system.nodes", TRUE);

  // Create local classes.
  $ADMINDATA = new cSYSTEMNODES ($zAPPLE->Context);
  ...
  if ($zLOCALUSER->userAccess->a == TRUE) {
    ...
    switch ($gACTION) {
      case 'EDIT':
        $zAPPLE->IncludeFile ("$gFRAMELOCATION/objects/admin/system/nodes/edit.aobj", INCLUDE_SECURITY_NONE);
      break;
      case 'NEW':
        $zAPPLE->IncludeFile ("$gFRAMELOCATION/objects/admin/system/nodes/new.aobj", INCLUDE_SECURITY_NONE);
      break;
      case 'SELECT_ALL':
      case 'DELETE_ALL':
      case 'MOVE_UP':
      ...
      default:
        if ( ($ADMINDATA->Error == 0) OR 
          ...
          $zAPPLE->IncludeFile ("$gFRAMELOCATION/objects/admin/system/nodes/list.top.aobj", INCLUDE_SECURITY_NONE);

          // Calculate scroll values.
          $gSCROLLMAX[$zAPPLE->Context] = $ADMINDATA->CountResult();

          // Adjust for a recently deleted entry.
          $zAPPLE->AdjustScroll ('admin.system.nodes', $ADMINDATA);
          ...
          $zAPPLE->IncludeFile ("$gFRAMELOCATION/objects/admin/system/nodes/list.bottom.aobj", INCLUDE_SECURITY_NONE);
  ...
  $zAPPLE->IncludeFile ("$gFRAMELOCATION/frames/admin/system/nodes.afrw", INCLUDE_SECURITY_NONE);
