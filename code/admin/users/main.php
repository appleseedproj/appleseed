<?php
  ...
  // | LOCATION: /code/admin/users/                 MODIFIED: 02-20-2005 +
  // +-------------------------------------------------------------------+
  ...
  $zAPPLE->IncludeFile ("$gFRAMELOCATION/frames/admin/users/main.afrw", INCLUDE_SECURITY_NONE);
