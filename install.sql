...
CREATE TABLE `%PREFIX%authTokens` ( `tID` int(10) unsigned NOT NULL auto_increment, `Username` varchar(32) NOT NULL default '', `Domain` varchar(128) NOT NULL default '', `Token` varchar(32) default NULL, `Stamp` datetime default NULL, `Source` int(11) default NULL, `Address` varchar(16) default NULL, `Host` varchar(128) default NULL, PRIMARY KEY  (`tID`) ) ENGINE=InnoDB DEFAULT CHARSET=latin1;

DROP TABLE IF EXISTS `%PREFIX%authVerification`;
CREATE TABLE `%PREFIX%authVerification` ( `tID` int(10) unsigned NOT NULL auto_increment, `Username` varchar(32) NOT NULL default '', `Domain` varchar(128) NOT NULL default '', `Verified` int(1) default NULL, `Address` varchar(16) default '0.0.0.0', `Host` varchar(128) default NULL, `Active` int(1) default NULL, `Stamp` datetime default NULL, PRIMARY KEY  (`tID`) ) ENGINE=InnoDB DEFAULT CHARSET=latin1;

DROP TABLE IF EXISTS `%PREFIX%commentInformation`;
CREATE TABLE `%PREFIX%commentInformation` ( `tID` int(10) unsigned NOT NULL auto_increment, `rID` int(10) unsigned zerofill default NULL, `Context` varchar(32) default NULL, `parent_tID` int(10) unsigned default NULL, `Subject` varchar(128) default NULL, `Body` text, `Stamp` datetime default NULL, `Owner_Username` varchar(32) NOT NULL default '', `Owner_Domain` varchar(128) NOT NULL default '', `Owner_Icon` varchar(32) NOT NULL default '', `Owner_Address` varchar(16) default '0.0.0.0', PRIMARY KEY  (`tID`), KEY `commentInformation_referenceIndex` (`rID`,`Context`) ) ENGINE=InnoDB DEFAULT CHARSET=latin1;

DROP TABLE IF EXISTS `%PREFIX%contentArticles`;
CREATE TABLE `%PREFIX%contentArticles` ( `tID` int(10) unsigned zerofill NOT NULL auto_increment, `Title` varchar(128) default NULL, `Full` text, `Formatting` int(1) default NULL, `Language` char(2) default NULL, `Submitted_Username` varchar(64) default NULL, `Submitted_Domain` varchar(64) default NULL, `Verification` int(1) default '0', `Stamp` datetime default NULL, `Summary` text, PRIMARY KEY  (`tID`) ) ENGINE=MyISAM DEFAULT CHARSET=latin1;

--
-- Table structure for table `contentNodes`
--

DROP TABLE IF EXISTS `%PREFIX%contentNodes`;
CREATE TABLE `%PREFIX%contentNodes` (
...
--
-- Dumping data for table `contentNodes`
--
-- ORDER BY:  `tID`

LOCK TABLES `%PREFIX%contentNodes` WRITE;
/*!40000 ALTER TABLE `%PREFIX%contentNodes` DISABLE KEYS */;
/*!40000 ALTER TABLE `%PREFIX%contentNodes` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Dumping data for table `friendCircles`
--
-- ORDER BY:  `tID`

LOCK TABLES `%PREFIX%friendCircles` WRITE;
/*!40000 ALTER TABLE `%PREFIX%friendCircles` DISABLE KEYS */;
/*!40000 ALTER TABLE `%PREFIX%friendCircles` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Dumping data for table `friendCirclesList`
--
-- ORDER BY:  `tID`

LOCK TABLES `%PREFIX%friendCirclesList` WRITE;
/*!40000 ALTER TABLE `%PREFIX%friendCirclesList` DISABLE KEYS */;
/*!40000 ALTER TABLE `%PREFIX%friendCirclesList` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Dumping data for table `friendInformation`
--
-- ORDER BY:  `tID`

LOCK TABLES `%PREFIX%friendInformation` WRITE;
/*!40000 ALTER TABLE `%PREFIX%friendInformation` DISABLE KEYS */;
/*!40000 ALTER TABLE `%PREFIX%friendInformation` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `%PREFIX%groupContent` (
  ...
  `latest_tID` int(10) unsigned default NULL,
  PRIMARY KEY  (`tID`),
...
--
-- Dumping data for table `groupContent`
--
-- ORDER BY:  `tID`

LOCK TABLES `%PREFIX%groupContent` WRITE;
/*!40000 ALTER TABLE `%PREFIX%groupContent` DISABLE KEYS */;
/*!40000 ALTER TABLE `%PREFIX%groupContent` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Dumping data for table `groupInformation`
--
-- ORDER BY:  `tID`

LOCK TABLES `%PREFIX%groupInformation` WRITE;
/*!40000 ALTER TABLE `%PREFIX%groupInformation` DISABLE KEYS */;
/*!40000 ALTER TABLE `%PREFIX%groupInformation` ENABLE KEYS */;
UNLOCK TABLES;
...
LOCK TABLES `%PREFIX%groupMembers` WRITE;
/*!40000 ALTER TABLE `%PREFIX%groupMembers` DISABLE KEYS */;
/*!40000 ALTER TABLE `%PREFIX%groupMembers` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- ORDER BY:  `tID`,`userAuth_uID`

LOCK TABLES `%PREFIX%journalPost` WRITE;
/*!40000 ALTER TABLE `%PREFIX%journalPost` DISABLE KEYS */;
/*!40000 ALTER TABLE `%PREFIX%journalPost` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Dumping data for table `journalPrivacy`
--
-- ORDER BY:  `tID`,`userAuth_uID`,`journalPost_tID`

LOCK TABLES `%PREFIX%journalPrivacy` WRITE;
/*!40000 ALTER TABLE `%PREFIX%journalPrivacy` DISABLE KEYS */;
/*!40000 ALTER TABLE `%PREFIX%journalPrivacy` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `%PREFIX%messageAttachments` (
  `tID` int(10) unsigned NOT NULL auto_increment,
  `messageStore_tID` int(10) unsigned NOT NULL,
  `Filename` varchar(128) default NULL,
  PRIMARY KEY  (`tID`),
  KEY `messageAttachments_FKIndex1` (`messageStore_tID`)
...
LOCK TABLES `%PREFIX%messageAttachments` WRITE;
/*!40000 ALTER TABLE `%PREFIX%messageAttachments` DISABLE KEYS */;
/*!40000 ALTER TABLE `%PREFIX%messageAttachments` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Dumping data for table `messageInformation`
--
-- ORDER BY:  `tID`

LOCK TABLES `%PREFIX%messageInformation` WRITE;
/*!40000 ALTER TABLE `%PREFIX%messageInformation` DISABLE KEYS */;
/*!40000 ALTER TABLE `%PREFIX%messageInformation` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Dumping data for table `messageLabelList`
--
-- ORDER BY:  `tID`

LOCK TABLES `%PREFIX%messageLabelList` WRITE;
/*!40000 ALTER TABLE `%PREFIX%messageLabelList` DISABLE KEYS */;
/*!40000 ALTER TABLE `%PREFIX%messageLabelList` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Dumping data for table `messageLabels`
--
-- ORDER BY:  `tID`

LOCK TABLES `%PREFIX%messageLabels` WRITE;
/*!40000 ALTER TABLE `%PREFIX%messageLabels` DISABLE KEYS */;
/*!40000 ALTER TABLE `%PREFIX%messageLabels` ENABLE KEYS */;
UNLOCK TABLES;
...
LOCK TABLES `%PREFIX%messageNotification` WRITE;
/*!40000 ALTER TABLE `%PREFIX%messageNotification` DISABLE KEYS */;
/*!40000 ALTER TABLE `%PREFIX%messageNotification` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `%PREFIX%messageRecipient` (
  `tID` int(10) unsigned NOT NULL auto_increment,
  `messageStore_tID` int(10) unsigned NOT NULL,
  `userAuth_uID` int(10) unsigned zerofill NOT NULL,
  `Identifier` varchar(128) default NULL,
  `Username` varchar(128) default NULL,
  `Domain` varchar(128) default NULL,
  `Standing` int(10) unsigned default NULL,
...
LOCK TABLES `%PREFIX%messageRecipient` WRITE;
/*!40000 ALTER TABLE `%PREFIX%messageRecipient` DISABLE KEYS */;
/*!40000 ALTER TABLE `%PREFIX%messageRecipient` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Dumping data for table `messageStore`
--
-- ORDER BY:  `tID`

LOCK TABLES `%PREFIX%messageStore` WRITE;
/*!40000 ALTER TABLE `%PREFIX%messageStore` DISABLE KEYS */;
/*!40000 ALTER TABLE `%PREFIX%messageStore` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Dumping data for table `photoInformation`
--
-- ORDER BY:  `tID`,`userAuth_uID`,`photoSets_tID`

LOCK TABLES `%PREFIX%photoInformation` WRITE;
/*!40000 ALTER TABLE `%PREFIX%photoInformation` DISABLE KEYS */;
/*!40000 ALTER TABLE `%PREFIX%photoInformation` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Dumping data for table `photoPrivacy`
--
-- ORDER BY:  `tID`,`userAuth_uID`,`photoSets_tID`

LOCK TABLES `%PREFIX%photoPrivacy` WRITE;
/*!40000 ALTER TABLE `%PREFIX%photoPrivacy` DISABLE KEYS */;
/*!40000 ALTER TABLE `%PREFIX%photoPrivacy` ENABLE KEYS */;
UNLOCK TABLES;
...
LOCK TABLES `%PREFIX%photoSets` WRITE;
/*!40000 ALTER TABLE `%PREFIX%photoSets` DISABLE KEYS */;
/*!40000 ALTER TABLE `%PREFIX%photoSets` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `%PREFIX%systemConfig` (
  `tID` int(10) unsigned NOT NULL auto_increment,
  `Concern` varchar(32) default NULL,
...
LOCK TABLES `%PREFIX%systemConfig` WRITE;
/*!40000 ALTER TABLE `%PREFIX%systemConfig` DISABLE KEYS */;
INSERT INTO `%PREFIX%systemConfig` VALUES (1,'Theme','ophelia'),(2,'Framework','default'),(3,'CascadeStrings','ON'),(4,'CascadeTooltips','ON'),(5,'UseInvites','ON'),(6,'InviteAmount','5'),(7,'StorageLimit','50'),(10,'Language','en'),(11,'NodeSummary','<asd id=\'global\' name=\'SITEDOMAIN\' case=\'proper\' /> is a new <a href=\'http://appleseed.sourceforge.net\'>Appleseed</a> node.');
/*!40000 ALTER TABLE `%PREFIX%systemConfig` ENABLE KEYS */;
UNLOCK TABLES;
...
LOCK TABLES `%PREFIX%systemLogs` WRITE;
/*!40000 ALTER TABLE `%PREFIX%systemLogs` DISABLE KEYS */;
/*!40000 ALTER TABLE `%PREFIX%systemLogs` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `systemMaintenance`
--

DROP TABLE IF EXISTS `%PREFIX%systemMaintenance`;
CREATE TABLE `%PREFIX%systemMaintenance` (
  `tID` int(10) unsigned NOT NULL auto_increment,
...
--
-- Dumping data for table `systemMaintenance`
--
-- ORDER BY:  `tID`

LOCK TABLES `%PREFIX%systemMaintenance` WRITE;
/*!40000 ALTER TABLE `%PREFIX%systemMaintenance` DISABLE KEYS */;
INSERT INTO `%PREFIX%systemMaintenance` VALUES (2,'UPDATE_NODE_NETWORK','2007-06-30 15:08:41',120);
/*!40000 ALTER TABLE `%PREFIX%systemMaintenance` ENABLE KEYS */;
UNLOCK TABLES;
...
DROP TABLE IF EXISTS `%PREFIX%systemNodes`;
CREATE TABLE `%PREFIX%systemNodes` (
  `tID` int(10) unsigned NOT NULL auto_increment,
  `Entry` varchar(128) default NULL,
  `Trust` int(10) unsigned default NULL,
  `Stamp` datetime default NULL,
  `EndStamp` datetime default NULL,
  `Share` int(10) unsigned default NULL,
...
LOCK TABLES `%PREFIX%systemNodes` WRITE;
/*!40000 ALTER TABLE `%PREFIX%systemNodes` DISABLE KEYS */;
INSERT INTO `%PREFIX%systemNodes` VALUES (1,'appleseedproject.org',10,'2007-06-30 18:21:45','0000-00-00 00:00:00',120,'localhost',1,1);
/*!40000 ALTER TABLE `%PREFIX%systemNodes` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Table structure for table `tagInformation`
--

DROP TABLE IF EXISTS `%PREFIX%tagInformation`;
CREATE TABLE `%PREFIX%tagInformation` (
  `tID` int(10) unsigned NOT NULL auto_increment,
  `Name` varchar(32) default NULL,
  PRIMARY KEY  (`tID`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
--
-- Dumping data for table `tagInformation`
--
-- ORDER BY:  `tID`

LOCK TABLES `%PREFIX%tagInformation` WRITE;
/*!40000 ALTER TABLE `%PREFIX%tagInformation` DISABLE KEYS */;
/*!40000 ALTER TABLE `%PREFIX%tagInformation` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `%PREFIX%tagList` (
  `tID` int(10) unsigned NOT NULL auto_increment,
  `userAuth_uID` int(10) unsigned zerofill NOT NULL,
  `tagInformation_tID` int(10) unsigned NOT NULL,
  ...
  `Stamp` datetime default NULL,
  PRIMARY KEY  (`tID`),
  KEY `tagList_FKIndex1` (`tagInformation_tID`),
  KEY `tagList_FKIndex2` (`userAuth_uID`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
LOCK TABLES `%PREFIX%tagList` WRITE;
/*!40000 ALTER TABLE `%PREFIX%tagList` DISABLE KEYS */;
/*!40000 ALTER TABLE `%PREFIX%tagList` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- ORDER BY:  `tID`,`userAuth_uID`,`userQuestions_tID`

LOCK TABLES `%PREFIX%userAnswers` WRITE;
/*!40000 ALTER TABLE `%PREFIX%userAnswers` DISABLE KEYS */;
/*!40000 ALTER TABLE `%PREFIX%userAnswers` ENABLE KEYS */;
UNLOCK TABLES;
...
LOCK TABLES `%PREFIX%userBlocks` WRITE;
/*!40000 ALTER TABLE `%PREFIX%userBlocks` DISABLE KEYS */;
/*!40000 ALTER TABLE `%PREFIX%userBlocks` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- ORDER BY:  `userAuth_uID`

LOCK TABLES `%PREFIX%userInformation` WRITE;
/*!40000 ALTER TABLE `%PREFIX%userInformation` DISABLE KEYS */;
INSERT INTO `%PREFIX%userInformation` VALUES (0000000001,NULL,'2007-04-10 12:13:17','2007-06-29 15:05:01','2007-06-04 15:18:33','2007-05-21 15:58:43','2007-06-29 15:10:06');
/*!40000 ALTER TABLE `%PREFIX%userInformation` ENABLE KEYS */;
UNLOCK TABLES;
...
LOCK TABLES `%PREFIX%userInvites` WRITE;
/*!40000 ALTER TABLE `%PREFIX%userInvites` DISABLE KEYS */;
/*!40000 ALTER TABLE `%PREFIX%userInvites` ENABLE KEYS */;
UNLOCK TABLES;
...
LOCK TABLES `%PREFIX%userPreferences` WRITE;
/*!40000 ALTER TABLE `%PREFIX%userPreferences` DISABLE KEYS */;
/*!40000 ALTER TABLE `%PREFIX%userPreferences` ENABLE KEYS */;
UNLOCK TABLES;
...
LOCK TABLES `%PREFIX%userPrivacy` WRITE;
/*!40000 ALTER TABLE `%PREFIX%userPrivacy` DISABLE KEYS */;
/*!40000 ALTER TABLE `%PREFIX%userPrivacy` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `%PREFIX%userProfile` VALUES (0000000001,'admin@localhost','Administrator','<center><b>I am root!</b></center>',NULL,'1969-10-31 00:00:00','11111',NULL);
...
LOCK TABLES `%PREFIX%userSessions` WRITE;
/*!40000 ALTER TABLE `%PREFIX%userSessions` DISABLE KEYS */;
/*!40000 ALTER TABLE `%PREFIX%userSessions` ENABLE KEYS */;
UNLOCK TABLES;
...
LOCK TABLES `%PREFIX%userSettings` WRITE;
/*!40000 ALTER TABLE `%PREFIX%userSettings` DISABLE KEYS */;
/*!40000 ALTER TABLE `%PREFIX%userSettings` ENABLE KEYS */;
UNLOCK TABLES;
...
LOCK TABLES `%PREFIX%userTokens` WRITE;
/*!40000 ALTER TABLE `%PREFIX%userTokens` DISABLE KEYS */;
/*!40000 ALTER TABLE `%PREFIX%userTokens` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2007-06-30 17:10:56
